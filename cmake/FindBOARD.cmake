...
MESSAGE(STATUS "Found BOARD_INCLUDE_DIR=: ${BOARD_INCLUDE_DIR}")

SET(BOARD_NAMES ${BOARD_NAMES} board Board)
FIND_LIBRARY(BOARD_LIBRARY
  NAMES ${BOARD_NAMES}
  PATHS /usr/lib /usr/local/lib "${BOARD_ROOT_DIR}"
  )

MESSAGE(STATUS "Found BOARD_LIBRARY=: ${BOARD_LIBRARY}")
